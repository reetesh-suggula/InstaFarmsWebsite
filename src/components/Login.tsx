import { Autocomplete, Box, Button, Divider, TextField, styled } from '@mui/material';
...
export const LogIn = (props: login) => {
    ...
    useEffect(() => {
        window.otpless = async (otplessUser: any) => {
            const data: any = otplessUser;
            await auth.signIn(data.waNumber)
                .then(() => {
                    const registerData = {
                        phoneNumber: data.waNumber,
                        email: "",
                        firstName: "",
                        lastName: "",
                    };
                    return user.register(registerData);
                })
                .then(() => {
                    dispatch({
    ...
    return (
        ...
        //         </Button>
        //     </p>
        //     <Button style={{ color: 'white', borderRadius: "7px", fontStyle: "Plus Jakarta Sans", fontWeight: "700", background: "#8C684D", width: "60%" }} onClick={() => {
        //         dispatch({
        //             type: Actions.SET_IS_LOGGGED_IN,
        //             data: true
        //         })
        //     }}>Continue</Button>
        //     <Root>
        //         <Divider sx={{ color: "black" }}>or</Divider></Root>

        //     <div style={{ display: "flex", marginTop: "12px" }}>
        //         <Button sx={{ border: "1px solid black", marginRight: "10px", width: "90px" }}><img src='/images/fbIcon.svg' alt="fblogin"></img></Button>
